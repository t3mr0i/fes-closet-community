...
final class zzd {
    private static void zzb(Context context, String str, Intent intent) {
        ...
        if (appMeasurementZzcs != null) {
            appMeasurementZzcs.logEventInternal(AppMeasurement.FCM_ORIGIN, str, bundle);
        } else {
    ...
    public static void zzg(Context context, Intent intent) throws NoSuchMethodException, InstantiationException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public static void zzh(Context context, Intent intent) {
        if (intent != null) {
            if ("1".equals(intent.getStringExtra("google.c.a.tc"))) {
                ...
                if (appMeasurementZzcs != null) {
                    String stringExtra = intent.getStringExtra("google.c.a.c_id");
                    appMeasurementZzcs.setUserPropertyInternal(AppMeasurement.FCM_ORIGIN, AppMeasurement.UserProperty.FIREBASE_LAST_NOTIFICATION, stringExtra);
                    Bundle bundle = new Bundle();
                    ...
                    appMeasurementZzcs.logEventInternal(AppMeasurement.FCM_ORIGIN, "_cmp", bundle);
                } else {
