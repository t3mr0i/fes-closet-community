...
final class zzcbb extends SQLiteOpenHelper {
    ...
    zzcbb(zzcay zzcayVar, Context context, String str) {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        ...
        try {
            ...
            String strZzawj = zzcax.zzawj();
            if (!this.zzinc.getContext().getDatabasePath(strZzawj).delete()) {
                this.zzinc.zzaum().zzaye().zzj("Failed to delete corrupted db file", strZzawj);
            }
            try {
                ...
                this.zzinc.zzaum().zzaye().zzj("Failed to open freshly created database", e2);
                throw e2;
            }
        }
    }
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) throws IllegalStateException, SQLException {
        ...
        zzcay.zza(this.zzinc.zzaum(), sQLiteDatabase, "events", "CREATE TABLE IF NOT EXISTS events ( app_id TEXT NOT NULL, name TEXT NOT NULL, lifetime_count INTEGER NOT NULL, current_bundle_count INTEGER NOT NULL, last_fire_timestamp INTEGER NOT NULL, PRIMARY KEY (app_id, name)) ;", "app_id,name,lifetime_count,current_bundle_count,last_fire_timestamp", null);
