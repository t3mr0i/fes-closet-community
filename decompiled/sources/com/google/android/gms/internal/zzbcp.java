...
public final class zzbcp {
    public static <T extends zzbco> T zza(Intent intent, String str, Parcelable.Creator<T> creator) {
    ...
    public static <T extends zzbco> T zza(byte[] bArr, Parcelable.Creator<T> creator) {
        com.google.android.gms.common.internal.zzbp.zzu(creator);
    ...
    public static <T extends zzbco> void zza(T t, Intent intent, String str) {
        intent.putExtra(str, zza(t));
    }

    public static <T extends zzbco> byte[] zza(T t) {
        Parcel parcelObtain = Parcel.obtain();
