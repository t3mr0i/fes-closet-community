...
final class zzegl {
    private static final zzegm zznev;

    static {
        zznev = zzegj.zzcds() && zzegj.zzcdt() ? new zzegp() : new zzegn();
    }

    static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zznev.zzb(charSequence, bArr, i, i2);
    }
    ...
    public static boolean zze(byte[] bArr, int i, int i2) {
        return zznev.zzb(0, bArr, i, i2) == 0;
    }
