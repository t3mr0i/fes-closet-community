...
public final class ResourcesCompat {
    ...
    private static Typeface loadFont(@NonNull Context context, int id, TypedValue value, int style, @Nullable TextView targetView) throws Resources.NotFoundException {
    ...
    private static Typeface loadFont(@NonNull Context context, Resources wrapper, TypedValue value, int id, int style, @Nullable TextView targetView) throws Resources.NotFoundException {
        Typeface cached;
