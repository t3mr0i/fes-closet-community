...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    @Override // android.support.v4.app.FragmentManager
    public boolean executePendingTransactions() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
    ...
    private static void setHWLayerAnimListenerIfAlpha(View v, AnimationOrAnimator anim) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    private static Animation.AnimationListener getAnimationListener(Animation animation) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        try {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        ...
        */
    void moveToState(android.support.v4.app.Fragment r15, int r16, int r17, int r18, boolean r19) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException, android.content.res.Resources.NotFoundException, java.lang.IllegalArgumentException {
        /*
    ...
    private void animateRemoveFragment(@NonNull final Fragment fragment, @NonNull AnimationOrAnimator anim, int newState) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        ...
        if (anim.animation != null) {
            ...
            animation.setAnimationListener(new AnimationListenerWrapper(listener) { // from class: android.support.v4.app.FragmentManagerImpl.2
                ...
                public void onAnimationEnd(Animation animation2) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        ...
        animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.v4.app.FragmentManagerImpl.3
            ...
            public void onAnimationEnd(Animator anim2) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
                if (container != null) {
    ...
    void completeShowHideFragment(final Fragment fragment) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
    ...
    void moveFragmentToExpectedState(Fragment f) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        if (f != null) {
    ...
    private void executePostponedTransaction(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        int index;
        int index2;
    ...
    private void removeRedundantOperationsAndExecute(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
    ...
    private int postponePostponableTransactions(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex, ArraySet<Fragment> added) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        int postponeIndex = endIndex;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void completeExecute(BackStackRecord record, boolean isPop, boolean runTransitions, boolean moveToState) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        if (isPop) {
    ...
    private static void executeOps(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        int i = startIndex;
        while (i < endIndex) {
            BackStackRecord record = records.get(i);
            boolean isPop = isRecordPop.get(i).booleanValue();
    ...
    private void addAddedFragments(ArraySet<Fragment> added) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        if (this.mCurState >= 1) {
    ...
    private void forcePostponedTransactions() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        if (this.mPostponedTransactions != null) {
    ...
    private void endAnimatingAwayFragments() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
    ...
    private boolean generateOpsForPendingActions(ArrayList<BackStackRecord> records, ArrayList<Boolean> isPop) throws Throwable {
        synchronized (this) {
            try {
    ...
    Parcelable saveAllState() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        int N;
    ...
    static class StartEnterTransitionListener implements Fragment.OnStartEnterTransitionListener {
        ...
        public void completeTransaction() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        ...
        public void cancelTransaction() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
