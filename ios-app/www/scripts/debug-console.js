...
(function () {
    ...
    el.id = 'debug-console';
    el.style.cssText = 'position:fixed;top:0;left:0;right:0;max-height:30%;overflow-y:auto;background:rgba(0,0,0,0.85);color:#0f0;font:9px monospace;padding:4px;z-index:99999;pointer-events:none;';
